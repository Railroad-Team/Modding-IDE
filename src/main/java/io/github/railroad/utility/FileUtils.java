...
public class FileUtils {
    ...
    public static File createFolder(String pathIn) { // Unused Method
        final File newFolder = new File(pathIn);
    ...
    public static File createNewFile(String pathIn) {
        try {
            final File dir = new File(pathIn);
    ...
    public static class Folder {
        ...
        public void refresh() {
            for (final File subfolder : FileUtils.getSubFolders(root))
                subFolders.add(new Folder(subfolder, depth + 1));
