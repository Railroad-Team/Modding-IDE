 ...
 * Uses factory-style construction to build a presence. This class is meant to be non-static for flexibility However, it
 * wouldn't be a bad idea to de objectify it later but then you lose options /shrug
 *
 * @author jojo2357
 */
public class DiscordRichPresenceManager {
	...
	public BigImageKeys lastBigImage = BigImageKeys.NONE;
	public String lastBigImageDetails = "";
	...
	/**
	 * The image key is for the big picture in the presence. {@link DiscordRichPresenceManager.BigImageKeys#KEY The key}
	 * is the name of the asset as it appears in the application While similar to {@link SmallImageKeys small keys} in
	 * pulling from the same assets, there may be some that dont show up right in one or the other so build accordingly
	 */
	...
	/**
	 * The image key is for the small picture in the presence. {@link DiscordRichPresenceManager.SmallImageKeys#KEY The
	 * key} is the name of the asset as it appears in the application While similar to {@link BigImageKeys small keys}
	 * in pulling from the same assets, there may be some that dont show up right in one or the other so build
	 * accordingly
	 */
